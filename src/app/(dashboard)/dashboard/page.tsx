...
import { ArrowLeftRight, Receipt, CreditCard, TrendingUp, TrendingDown, Wallet, ArrowUpRight, ArrowDownLeft } from 'lucide-react'
      ...
      <div className="hidden lg:block space-y-8">
        ...
        <Card className="border-primary/20 bg-white dark:bg-card">
          <CardContent className="p-6 lg:p-8">
            ...
            <p className="mt-2 text-4xl font-bold tracking-tight">{formatGBP(totalBalance)}</p>
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            { href: '/payments', icon: Receipt, label: 'Pay' },
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center gap-2 text-base">
                <div className="rounded-full bg-red-50 dark:bg-red-950/30 p-1.5">
