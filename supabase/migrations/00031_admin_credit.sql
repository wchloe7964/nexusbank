-- =============================================
-- 00031: ADMIN MANUAL CREDIT
-- Allows admins to credit customer accounts
-- for refunds, goodwill, corrections, etc.
-- =============================================

-- 1. Extend the transactions category check to include 'admin_credit'
...
ALTER TABLE public.transactions
  ...
  CHECK (category IN (
    ...
    'subscriptions', 'cash', 'other', 'payment', 'admin_credit'
  ));


-- 2. Atomic RPC: admin_credit_account
-- Credits a customer account with full transaction logging.
-- Called via admin client (service role), bypasses RLS.
